...
\subsection*{La caminata aleatoria como cadena de Markov homogénea}
...
\begin{remark}
Si considerásemos un proceso estocástico $\{Z_n : n \in \mathbb{N}\}$ donde cada $Z_n$ es una variable aleatoria independiente (no solo débilmente dependiente como en la caminata aleatoria, sino completamente independiente de las demás), entonces el proceso sería trivialmente una cadena de Markov homogénea: la probabilidad de transición sería:
\[
